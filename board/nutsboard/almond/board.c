 ...
 * board.c
 *
 * Board functions for NutsBoard - Almond SoM
 *
...
static int board_set_console(void)
{
	int val, i, dips = 0;
	char buf[7];
...
static const struct ddr_data ddr3_board_data = {
...
static const struct cmd_control ddr3_board_cmd_ctrl_data = {
...
static struct emif_regs ddr3_board_emif_reg_data = {
...
const struct dpll_params dpll_ddr_board = {
		400, OSC-1, 1, -1, -1, -1, -1};
...
const struct ctrl_ioregs ioregs_board = {
...
void sdram_init(void)
{
	...
	config_ddr(400, &ioregs_board,
		   &ddr3_board_data,
		   &ddr3_board_cmd_ctrl_data,
		   &ddr3_board_emif_reg_data, 0);
}
#endif
